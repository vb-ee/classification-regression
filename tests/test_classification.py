...
class TestClassification(unittest.TestCase):
    ...
    def test_data_types(self):
        ...
        self.assertIsInstance(self.classification_model._get_scalar().transform(self.classification_model.X_train), np.ndarray)
        self.assertIsInstance(self.classification_model._get_scalar().transform(self.classification_model.X_test), np.ndarray)
